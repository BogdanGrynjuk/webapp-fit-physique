  ...
  return (
    <section className="w-full">
      <div className="container mx-auto grid gap-4 xl:gap-8 sm:grid-cols-2">
        ...
        <p className="text-sm mobile:text-base sm:col-start-2 sm:row-start-2 lg:col-start-1 lg:col-span-2 xl:col-start-2 xl:row-start-2 self-center">
          {text}
        </p>
        ...
        {points && (
          <div className="flex flex-col gap-2 sm:col-span-2 lg:col-start-2 lg:col-span-1 xl:col-start-2 xl:row-start-3 self-center">
